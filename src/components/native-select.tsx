  ...
  return (
    <div className="relative">
      <select
        ...
        className={cn(
          "border-input focus-visible:border-ring focus-visible:ring-ring/50 dark:bg-input h-9 w-full min-w-0 appearance-none truncate rounded-lg border bg-transparent py-0 pr-8 pl-2.5 text-sm transition-colors outline-none focus-visible:ring-3 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      >
